          ...
          <div className="footer-links">
            ...
            <div className="footer-column2">
              ...
              <div className="footer-footer-links2">
                ...
                <a
                  href="https://docs.google.com/forms/d/e/1FAIpQLSfBZrufytpTHenXgYoNPvAT1hcrEtxx-V1zJS9HafqzlKqpEg/viewform?usp=sf_link"
                  target="_blank"
                  rel="noreferrer noopener"
                  className="thq-body-small"
                >
...
Footer.defaultProps = {
  ...
  link7: 'About Us',
  link5: 'Desktop Support Engineer',
  link6: 'Digital Marketing',
  link8: 'Contact Us',
  action1: 'Enroll Now',
  content3: '© 2022 Training Institute. All Rights Reserved.',
  link4: 'MySql',
  logoSrc: 'https://presentation-website-assets.teleporthq.io/logos/logo.png',
  cookiesLink: '/cookie-policy',
  content2: 'Stay connected with us on social media for updates and more.',
  link9: 'FAQs',
